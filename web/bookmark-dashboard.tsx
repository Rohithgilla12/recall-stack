...
import { bookmarkActions, bookmarkStats, bookmarkStore } from "@/lib/bookmark-store"
import { useStore } from "@tanstack/react-store"
import { api } from "convex/_generated/api"
import { useQuery } from "convex/react"
import { Archive, Bookmark, Calendar, ExternalLink, Folder, FolderPlus, Globe, Plus, Search, Tag } from "lucide-react"
      ...
      <div className="container mx-auto px-4 py-8 flex gap-6">
        ...
        <div className="mb-8 space-y-4">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            ...
            <Dialog open={isAddDialogOpen} onOpenChange={bookmarkActions.setIsAddDialogOpen}>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>Save a new bookmark to your collection</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => bookmarkActions.updateNewBookmark({ url: e.target.value })}
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => bookmarkActions.updateNewBookmark({ title: e.target.value })}
                    />
                  </div>
                  <div>
                    ...
                    <Textarea
                      ...
                      onChange={(e) => bookmarkActions.updateNewBookmark({ description: e.target.value })}
                    />
                  </div>
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => bookmarkActions.updateNewBookmark({ folder: value })}
                    >
                      <SelectTrigger>
                  ...
                  <Button onClick={bookmarkActions.addBookmark} className="w-full">
                    Save Bookmark
                  </Button>
                </div>
              </DialogContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
          <Card className="bg-gradient-to-br from-blue-50 to-blue-100 dark:from-blue-900/20 dark:to-blue-800/20 border-blue-200 dark:border-blue-800">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-blue-600 dark:text-blue-400">Total Bookmarks</p>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 border-orange-200 dark:border-orange-800">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-orange-600 dark:text-orange-400">Archived</p>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border-purple-200 dark:border-purple-800">
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-purple-600 dark:text-purple-400">Tags</p>
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <Dialog open={isFolderDialogOpen} onOpenChange={bookmarkActions.setIsFolderDialogOpen}>
              <DialogTrigger asChild>
              ...
              <DialogContent className="sm:max-w-md">
                <DialogHeader>
                  ...
                  <DialogDescription>Organize your bookmarks with folders</DialogDescription>
                </DialogHeader>
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => bookmarkActions.updateNewFolder({ name: e.target.value })}
                    />
                  </div>
                  <div>
                    ...
                    <Select
                      ...
                      onValueChange={(value) => bookmarkActions.updateNewFolder({ parentId: value || null })}
                    >
                      <SelectTrigger>
                  ...
                  <Button onClick={bookmarkActions.createFolder} className="w-full">
                    Create Folder
                  </Button>
                </div>
              </DialogContent>
            ...
            {folders.map((folder) => (
              ...
              >
                <CardContent className="p-4 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">{Math.floor(Math.random() * 10) + 1} items</p>
                </CardContent>
              </Card>
            ))}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {bookmarks.map((bookmark) => (
            <Card
              key={bookmark._id}
              className="group hover:shadow-lg transition-all duration-200 bg-white dark:bg-slate-800 border-0 shadow-sm hover:shadow-xl hover:-translate-y-1"
            >
              ...
              <CardContent className="pt-0">
                {bookmark.summary && (
                  <div className="mb-3 p-3 bg-slate-50 dark:bg-slate-700 rounded-lg">
                    <p className="text-sm text-muted-foreground line-clamp-2">
                      <span className="font-medium">AI Summary:</span> {bookmark.summary}
                    </p>
                  </div>
                )}
                <div className="flex flex-wrap gap-1 mb-3">
                  ...
                  {bookmark.aiSuggestedTags?.length && bookmark.aiSuggestedTags.length > 3 && (
